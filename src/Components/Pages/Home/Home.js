    ...
    <div className={style.wrapper}>
      <form className={style.filters}>
        <div className={style.inputWrapper}>
          ...
          <button onClick={inputHandler}>
            <FontAwesomeIcon icon={faMagnifyingGlass} color="#f8f9fa" />
          </button>
        </div>
        <div className={style.selectWrapper}>
          ...
          <button className={style.errorBtn} onClick={resetFilters}>
            reset filters
          </button>
        </div>
      </form>
      ...
      <div className={style.paginationWrapper}>
        <HashLink smooth to="#nav">
          <button className={style.btnPage} onClick={prevPageHandler}>
            Prev Page
          </button>
        </HashLink>
        <p>{page}</p>
        <HashLink smooth to="#nav">
          <button className={style.btnPage} onClick={nextPageHandler}>
            Next Page
          </button>
        </HashLink>
      </div>
